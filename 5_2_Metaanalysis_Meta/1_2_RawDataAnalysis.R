...
# Setup ####
setwd("G:/Mi unidad/_General/DoctoradoIndustrial2022/Publicaciones/METAANALISIS/Data/3_Extraction")
library(dplyr)
library(ggplot2)
set.seed(9396)
...
data <- xlsx::read.xlsx(file = "in/284_268_PubMed_Sup2.xlsx", sheetIndex = 2)
...
xlsx::write.xlsx(dfFinal, file = "in/284_268_PubMed_tablalogFCpval.xlsx", 
...
tab5 <- xlsx::read.xlsx(file = "in/377_100_PubMed/Table 5.XLSX", sheetIndex = 1)
...
# Saving #
xlsx::write.xlsx(x = dfAll, file = "in/377_100_PubMed/resultsDEP_DMvsControl.xlsx", 
...
# Saving 
xlsx::write.xlsx(x = dfAll, file = "in/377_100_PubMed/DEPs_cualitativo.xlsx", 
...
# Loading data #
datos <- xlsx::read.xlsx(file = "in/432_287_PubMed/tvst-9-13-8_s004.xlsx", 
                         sheetIndex = 1)
...
# Saving #
xlsx::write.xlsx(x = tab, file = "in/432_287_PubMed/table_DEPs_BC.xlsx", 
                 col.names = T, row.names = F, showNA = F)
...
proteinas <- xlsx::read.xlsx(file = "in/440_211_PubMed/Table 2.XLSX", 
                             sheetIndex = 1)
colnames(proteinas) <- proteinas[1,]
proteinas <- proteinas[-1,]
proteinas <- proteinas$`Protein IDs`
## Loading data from proteinGroups.txt
data <- read.table(file = "in/440_211_PubMed/txt/proteinGroups.txt", 
                   header = T, sep = "\t")
...
# Saving #
xlsx::write.xlsx(x = dfAll, file = "in/440_211_PubMed/resultsDEP_T2DMvsControl.xlsx", 
                 col.names = T, row.names = F, showNA = F)
...
## Reanalysis ####
# Loading data from proteinGroups.txt #
data0 <- read.table(file = "probablyIn/944_401_Scopus/search/proteinGroups.txt", 
                    header = T, sep = "\t")
...
# Saving #
xlsx::write.xlsx(x = dfAll, file = "probablyIn/944_401_Scopus/tablaDEPS_rawData.xlsx", 
                 col.names = T, row.names = F, showNA = F)
...
data0 <- xlsx::read.xlsx(file = "probablyOut/499_339_PubMed/S1Table.xls",
                         sheetIndex = 1)
...
# Saving #
xlsx::write.xlsx(x = dfAll, file = "probablyOut/499_339_PubMed/tableDEPs_withrawData.xlsx",
                 row.names = F, showNA = F)
...
# Loading TS1 #
data <- xlsx::read.xlsx(
  file = "probablyOut/1046_653_Scopus/1-s2.0-S2352396418300227-mmc2.xlsx", 
  sheetIndex = 1)
...
# Saving #
xlsx::write.xlsx(x = dfAll, file = "probablyOut/1046_653_Scopus/tableDEPs.xlsx",
                 row.names = F, showNA = F)
